  ...
  return (
    <div className={styles.headerRight}>
      <div className={styles.contact}>
        <div
          className={`${styles.contactIcon} ${
            isHeaderFixed ? styles.contactIconHF : ""
          }`}
        >
          ...
          <div>
            <a
              ...
              className={`${styles.big} ${styles.phone} ${
                isHeaderFixed ? styles.phoneHF : ""
              }`}
            >
              +7 (918) 432-65-87
            </a>
          </div>
          <div className={styles.small}>Ежедневно с 9:00 до 23:00</div>
        </div>
      </div>
      <div className={styles.order} onClick={cartIconClickHandler}>
        ...
        >
          <div className={styles.contactIconCount}>{inCart}</div>
          <img src="img/icon-cart.svg" alt="icon-cart" />
        </div>
        <div className={`${styles.contactText} ${mediaShow.xl}`}>
          <div className={`${styles.big} ${isHeaderFixed ? styles.bigHF : ""}`}>
            Ваш заказ
          </div>
          <div className={styles.small}>
            ...
            {inCart > 1 && (
              <>
                {` и ещё ${inCart - 1} ${writeCorrect(inCart - 1, [
                  "пицца",
                  "пиццы",
                  "пицц",
                ])}`}
      ...
      <div
        className={`${styles.lang} ${
          isHeaderFixed ? styles.langHF : ""
        } d-none d-sm-block`}
      >
        <div
          className={styles.big}
          onClick={() => console.log("меню переключения языков")}
        >
      ...
      <div
        className={`${styles.mMenu} ${mediaShow.lgDown} ${
          isHeaderFixed ? styles.langHF : ""
        }`}
      >
